    ...
    public class TicketController : Controller
        {
            ...
            public TicketController(IProductService productServicet)
            {
            ...
            [HttpPost]
            [ValidateAntiForgeryToken]
            public IActionResult Create([Bind("Id,ProductName,ProductImage,ProductDescription,ProductPrice,Rating")] Ticket product)
            {
            ...
            [HttpPost]
            [ValidateAntiForgeryToken]
            public IActionResult Edit(Guid id, [Bind("Id,ProductName,ProductImage,ProductDescription,ProductPrice,Rating")] Ticket product)
            {
                if (id != product.Id)
                {
                    return NotFound();
